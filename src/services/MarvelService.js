...
const useMarvelService = () => {
    ...
    const _apiKey = 'apikey=920f4bf8fae689e792556f4ea884f4db';
    ...
    return {process, setProcess, getAllCharacters, getCharacter, getAllComics, getSingleComic, getCharName, clearError}
